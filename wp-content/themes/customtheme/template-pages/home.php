                ...
                <div class="services__grid">
                    <article class="service-card animated-fadeInUp card-hover-anim">
                        <div class="service-card__image">
                            <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                                alt="Перевозка строительных материалов" class="service-card__img" />
                        </div>
                        <div class="service-card__content">
                            ...
                            <p class="service-card__description">
                                Доставка кирпича, блоков, цемента, плит и других стройматериалов манипулятором. Быстро,
                                аккуратно, по выгодной цене.
                            </p>
                            <div class="service-card__footer">
                                <div class="service-card__price">от 100 BYN</div>
                                <div class="service-card__buttons">
                                    <a href="/services/gas-silicate.html"
                                        class="service-card__link button-anim">Подробнее</a>
                                    <button class="service-card__button button-anim"
                                        data-service="Перевозка строительных материалов">
                                        Заказать
                                    </button>
                                </div>
                            </div>
                    ...
                    <article class="service-card animated-fadeInUp card-hover-anim">
                        <div class="service-card__image">
                            <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                                alt="Перевозка автомобилей" class="service-card__img" />
                        </div>
                        <div class="service-card__content">
                            <h3 class="service-card__title">Перевозка автомобилей</h3>
                            <p class="service-card__description">
                                Бережная транспортировка легковых и грузовых автомобилей
                            </p>
                            <div class="service-card__footer">
                                <div class="service-card__price">от 150 BYN</div>
                                <div class="service-card__buttons">
                                    <a href="/services/car-transport.html"
                                        class="service-card__link button-anim">Подробнее</a>
                                    <button class="service-card__button button-anim"
                                        data-service="Перевозка автомобилей">
                                        Заказать
                                    </button>
                                </div>
                            </div>
                    ...
                    <article class="service-card animated-fadeInUp card-hover-anim">
                        <div class="service-card__image">
                            <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                                alt="Перевозка негабаритных грузов" class="service-card__img" />
                        </div>
                        <div class="service-card__content">
                            <h3 class="service-card__title">
                            ...
                            <div class="service-card__footer">
                                <div class="service-card__price">от 200 BYN</div>
                                <div class="service-card__buttons">
                                    <a href="/services/oversized.html"
                                        class="service-card__link button-anim">Подробнее</a>
                                    <button class="service-card__button button-anim"
                                        data-service="Перевозка негабаритных грузов">
                                        Заказать
                                    </button>
                                </div>
                            </div>
                    ...
                    <article class="service-card animated-fadeInUp card-hover-anim">
                        <div class="service-card__image">
                            <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                                alt="Перевозка бытовок" class="service-card__img" />
                        </div>
                        <div class="service-card__content">
                            <h3 class="service-card__title">Перевозка бытовок</h3>
                            <p class="service-card__description">
                                Доставка и установка бытовок, вагончиков и модульных зданий на
                                объект.
                            </p>
                            <div class="service-card__footer">
                                <div class="service-card__price">от 250 BYN</div>
                                <div class="service-card__buttons">
                                    <a href="/services/cabin-transport.html"
                                        class="service-card__link button-anim">Подробнее</a>
                                    <button class="service-card__button button-anim" data-service="Перевозка бытовок">
                                        Заказать
                                    </button>
                                </div>
                            </div>
                    ...
                    <article class="service-card animated-fadeInUp card-hover-anim">
                        <div class="service-card__image">
                            <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
                                alt="Перевозка лесоматериалов" class="service-card__img" />
                        </div>
                        <div class="service-card__content">
                            <h3 class="service-card__title">Перевозка лесоматериалов</h3>
                            <p class="service-card__description">
                                Транспортировка пиломатериалов, брёвен, досок и других
                                лесоматериалов.
                            </p>
                            <div class="service-card__footer">
                                <div class="service-card__price">от 300 BYN</div>
                                <div class="service-card__buttons">
                                    <a href="/services/wood-transport.html"
                                        class="service-card__link button-anim">Подробнее</a>
                                    <button class="service-card__button button-anim"
                                        data-service="Перевозка лесоматериалов">
                                        Заказать
                                    </button>
                                </div>
                            </div>
                    ...
                    <article class="service-card animated-fadeInUp card-hover-anim">
                        ...
                        <div class="service-card__content">
                            <h3 class="service-card__title">Ремонт автомобилей</h3>
                            <p class="service-card__description">
                                Профессиональный ремонт автомобилей любой сложности.
                                Диагностика, обслуживание, гарантия на все виды работ.
                            </p>
                            <div class="service-card__footer">
                                <div class="service-card__price">от 50 BYN</div>
                                <div class="service-card__buttons">
                                    <a href="/services/vehicle-repair.html"
                                        class="service-card__link button-anim">Подробнее</a>
                                    <button class="service-card__button button-anim" data-service="Ремонт автомобилей">
                                        Заказать
                                    </button>
                                </div>
                            </div>
            ...
            <div class="content-container">
                <div class="feedback__content">
                    ...
                    <form class="feedback-form" id="feedbackForm">
                        <input type="hidden" name="service" id="serviceName" value="Заявка на консультацию" />
                        <div class="feedback-form__group">
                            <label class="feedback-form__label" for="name">Ваше имя</label>
                            <input type="text" class="feedback-form__input" id="name" name="name" required
                        ...
                        <div class="feedback-form__group">
                            <label class="feedback-form__label" for="message">Комментарий</label>
                            <textarea class="feedback-form__textarea" id="message" name="message"
                                placeholder="Опишите ваш вопрос или задачу"></textarea>
                        </div>

                        <div class="feedback-form__group feedback-form__group--checkbox">
                            <input type="checkbox" class="feedback-form__checkbox" id="privacy" name="privacy"
                                required />
                            <label class="feedback-form__label feedback-form__label--checkbox" for="privacy">
